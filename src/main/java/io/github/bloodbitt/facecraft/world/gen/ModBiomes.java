...
import io.github.bloodbitt.facecraft.biomes.FaceFlats;
...
public class ModBiomes {
    ...
    public static final RegistryObject<Biome> FACE_FLATS = BIOMES.register("face_flats", FaceFlats::makeFaceFlats);
    public static final RegistryKey<Biome> FACE_FLATS_KEY = RegistryKey.getOrCreateKey(
            Registry.BIOME_KEY, new ResourceLocation("facecraft", "face_flats"));
    ...
    public static void biomeLoading(BiomeLoadingEvent event) {
        ...
        if (event.getName() == FACE_FLATS.getId()) {
            BiomeManager.addBiome(BiomeManager.BiomeType.WARM,
                    new BiomeManager.BiomeEntry(FACE_FLATS_KEY ,500));
        }
    }
